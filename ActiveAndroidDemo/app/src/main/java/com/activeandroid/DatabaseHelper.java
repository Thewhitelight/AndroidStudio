...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        executePragmas(db);
        executeCreate(db);
        // TODO executeMigrations() Delete by XuShaojie at 3.9
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        executePragmas(db);
        executeCreate(db);
        // TODO executeMigrations2() Replace by XuShaojie at 3.9
        //	executeMigrations(db, oldVersion, newVersion);
        //executeMigrations2(db, oldVersion, newVersion);
    }
...
//	}
    ...
    // TODO Modify by XuShaojie at 1.0 BEGIN
    // ---------------------------------------------------------------------------------------------
/*    private void executeMigrations2(SQLiteDatabase db, int oldVersion, int newVersion) {
        List<DBUpdateHelper.SQL> values = DBUpdateHelper.getSql();
        db.beginTransaction();
        try {
            for (DBUpdateHelper.SQL value : values) {
                int version = value.getVersion();
                if (version > oldVersion && version <= newVersion) {
                    String[] sqlArray = value.getSql();
                    if (sqlArray == null) {
                        return;
                    }
    ...
    // TODO Modify by XuShaojie at 1.0 END
    // ---------------------------------------------------------------------------------------------
