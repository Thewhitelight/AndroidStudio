...
package cn.libery.pickdialog.widget;
...
import cn.libery.pickdialog.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (topShadow == null) {
            topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, null/*SHADOWS_COLORS*/);
        }

        if (bottomShadow == null) {
            bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, null/*SHADOWS_COLORS*/);
        }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 绘制上边直线
        canvas.drawLine(25, center - offset, getWidth() - 25, center - offset, paint);
        // 绘制下边直线
        canvas.drawLine(25, center + offset, getWidth() - 25, center + offset, paint);
        // */
    }
